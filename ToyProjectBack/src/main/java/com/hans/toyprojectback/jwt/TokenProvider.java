...
public class TokenProvider implements InitializingBean {
	...
	public TokenProvider(@Value("${jwt.secret}") String secret, @Value("${jwt.token-validity-in-seconds}") long tokenValidityInMillseconds) {
		// application.properties에 정의한 값 주입
		this.secret = secret;
	...
	public void afterPropertiesSet() throws Exception {
		// Bean이 생성되고 의존성 주입까지 끝낸 이후에 주입받은 secret 값을 base64 decode하여 key 변수에 할당
